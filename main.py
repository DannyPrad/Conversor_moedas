...
título = customtkinter.CTkLabel(janela, text="Conversor de Moedas", font=("",20) )
...
moedas_disponíveis = ["USD: Dólar american", "BRL: Real brasileiro", "BTC: Bitcoin"]
for moeda in moedas_disponíveis:
