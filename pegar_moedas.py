...
def conversoes_disponiveis():
    ...
    dic_conversoes_diponiveis = {}
    for par_conversao in conversoes:
        moeda_origem, moeda_destino = par_conversao.split("-")
        if moeda_origem in dic_conversoes_diponiveis:
            dic_conversoes_diponiveis[moeda_origem].append(moeda_destino)
        else:
            dic_conversoes_diponiveis[moeda_origem] = [moeda_destino]
    
    # Certifique-se de retornar o dicionário após o processamento
    return dic_conversoes_diponiveis
